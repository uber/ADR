...
> This is the fast, per-commit instrument. For the end-to-end measurement — real tools installed on macOS, Linux and Windows VMs, scored against what the collector reports — see [README.md](README.md).
