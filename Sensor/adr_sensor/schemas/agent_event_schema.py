...
Harness, Warp, opencode, and Claude Desktop into a common format for security analysis.
"""
...
class AgentEvent:
    ...
    # Core fields
    timestamp: datetime
    source: str  # claude, cursor, cline, warp, codex, copilot, dsh, claude_desktop, opencode
    session_id: str
