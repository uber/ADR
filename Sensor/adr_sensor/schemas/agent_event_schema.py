...
Normalizes logs from Claude Code, Cursor, Cline, Codex, Copilot CLI, Warp,
opencode, Gemini CLI, and Claude Desktop into a common format for security analysis.
"""
...
class AgentEvent:
    ...
    # Core fields
    timestamp: datetime
    source: str  # claude, cursor, cline, warp, codex, copilot, claude_desktop, opencode, gemini
    session_id: str
